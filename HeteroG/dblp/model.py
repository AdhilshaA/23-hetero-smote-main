...
class Het_Agg(nn.Module):
    ...
    def forward(self, x_list, edges_list, x_node, num_node):
        ...
        t_aggr = self.t_aggregate(x_list[2], edges_list[2], num_node)
        c_aggr = self.c_aggregate(x_list[3], edges_list[3], num_node)
...
class Het_NetEn(nn.Module):
    ...
    def forward(self, x_list, data):
        ...
        x_list[2] = self.t_het(x_list, t_edges_list, x_list[2], x_list[2].size(0))
        x_list[3] = self.c_het(x_list, c_edges_list, x_list[3], x_list[3].size(0))

...
class Het_NetEn(nn.Module):
    ...
    def forward(self, x_list, data):
        ...
        x_list[0] = self.a_het(x_list, a_edges_list, x_list[0], x_list[0].size(0)) 
        x_list[1] = self.p_het(x_list, p_edges_list, x_list[1], x_list[1].size(0))
        x_list[2] = self.v_het(x_list, v_edges_list, x_list[2], x_list[2].size(0))

...
def train_smote(data, edge_indices, encoder1, encoder2, classifier, decoder_list, train_idx, 
    ...
    for epoch in range(args.num_epochs):
        ...
        if os_mode == 'embed_sm' or os_mode == 'gsm' or os_mode == 'em_smote': x_list = encoder2(x_list, data)
        ...
        if os_mode != 'embed_sm' and os_mode != 'gsm' and os_mode != 'em_smote': x_list = encoder2(x_list, data)
